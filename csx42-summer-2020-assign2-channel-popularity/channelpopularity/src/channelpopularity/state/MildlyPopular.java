...
/**
* MildlyPopular is one of the states.
*
...
public class MildlyPopular implements StateI {
	...
	*/
	...
	public void addVideo(String name, ContextI channelContext) {
		...
		InputProcessor.str.append("MILDLY_POPULAR__VIDEO_ADDED::" + name);
	}
	...
	*/
	...
	public void removeVideo(Video video, ContextI channelContext) {
		...
		InputProcessor.str.append("MILDLY_POPULAR__VIDEO_REMOVED::" + video.name);
	}
	...
	*/
	...
	public void calculateMetrics(ContextI channelContext) {
		MetricsCalculator met = new MetricsCalculator();
		channelContext.setCurrentState(met.getStateByMetrics());
		InputProcessor.str.append("MILDLY_POPULAR__POPULARITY_SCORE_UPDATE::" + ChannelContext.avgPopularityScore);
	}		
	...
	*/
	...
	public void adRequest(int length) {
		if(length > 1 && length <= 20 )
			InputProcessor.str.append("MILDLY_POPULAR__AD_REQUEST::APPROVED");
		else
			InputProcessor.str.append("MILDLY_POPULAR__AD_REQUEST::REJECTED");
	}
}
