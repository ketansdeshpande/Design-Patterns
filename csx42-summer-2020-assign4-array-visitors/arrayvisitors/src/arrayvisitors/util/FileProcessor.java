...
public final class FileProcessor {
	...
	*/
	public void setFileProcessor(String inputFilePath)
		...
		MyLogger.writeMessage("FileProcessor : Successfully opened the file " + inputFilePath, MyLogger.DebugLevel.CONSTRUCTOR);
	}
	...
	*/
	public void close() throws IOException {
		reader.close();
		MyLogger.writeMessage("FileProcessor : reader is closed.", MyLogger.DebugLevel.FILE_PROCESSOR);
	}
}
